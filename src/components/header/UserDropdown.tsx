...
export default function UserDropdown() {
  ...
  // Get first name for display (if full name exists, show only first name)
  const displayName = userDetails.name ? userDetails.name.split(' ')[0] : "User";
    ...
    <div className="relative">
      ...
      >
        ...
        <Link
          ...
          onClick={() => {
            // Clear token and user info on sign out
